// app/screens/worker/profile.tsx
...
import { WorkerProfileStackParamList } from '../navigators/workerNavigator';

type ProfileScreenNavigationProp = StackNavigationProp<WorkerProfileStackParamList>;
...
export default function WorkerProfileScreen() {
  ...
  // Navigate to a tab screen from stack navigator
  const navigateToTab = (tabName: string) => {
    // Use CommonActions to navigate to a screen in the parent navigator
    navigation.dispatch(
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
              ...
              {isEditingName ? (
                ...
                <View style={styles.nameContainer}>
                  <Text style={styles.nameText}>
                    {user.displayName || user.email?.split('@')[0] || 'Worker'}
                  </Text>
                  <TouchableOpacity
        ...
        <View style={styles.sectionContainer}>
          <Text style={styles.sectionTitle}>Worker Tools</Text>
          
          <TouchableOpacity 
            style={styles.menuItem} 
            onPress={() => navigateToTab('ManageSpaces')}
          >
            <View style={styles.menuItemIconContainer}>
              <Ionicons name="car-outline" size={20} color={colors.primary} />
            </View>
            <View style={styles.menuItemContent}>
              <Text style={styles.menuItemTitle}>Manage Parking Spaces</Text>
              <Ionicons name="chevron-forward" size={20} color={colors.textLight} />
            </View>
          </TouchableOpacity>
          ...
          <View style={styles.menuItem}>
            ...
            <View style={styles.menuItemContent}>
              <Text style={styles.menuItemTitle}>Today's Statistics</Text>
              <View style={styles.statsContainer}>
                <View style={styles.statItem}>
                  <Text style={styles.statValue}>{user.role === 'worker' ? '12' : '0'}</Text>
                  <Text style={styles.statLabel}>Managed</Text>
                </View>
                <View style={styles.statItem}>
                  <Text style={styles.statValue}>{user.role === 'worker' ? '8' : '0'}</Text>
                  <Text style={styles.statLabel}>Checked In</Text>
                </View>
                <View style={styles.statItem}>
                  <Text style={styles.statValue}>{user.role === 'worker' ? '4' : '0'}</Text>
